...
export class UpdateAnimalDto {
  @ApiPropertyOptional({ description: "Code de l'animal" })
  @IsOptional()
  @IsString()
  code?: string;
  ...
  @ApiPropertyOptional({ description: 'Actif (déprécié, utiliser statut)' })
  @IsOptional()
  @IsBoolean()
  actif?: boolean;
  ...
  @ApiPropertyOptional({ description: 'Est reproducteur' })
  @IsOptional()
  @IsBoolean()
