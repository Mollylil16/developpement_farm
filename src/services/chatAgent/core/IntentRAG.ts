...
export const INTENT_KNOWLEDGE_BASE: TrainingExample[] = [
  ...
  { text: 'composition d aliment', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'composition alimentaire', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'bonne composition aliment', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'composition aliment porc', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'composition aliment croissance', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'donne moi composition aliment', action: 'answer_knowledge_question', params: { topic: 'alimentation' }, confidence: 0.95 },
  { text: 'propose composition aliment', action: 'propose_composition_alimentaire', params: {}, confidence: 0.95 },
