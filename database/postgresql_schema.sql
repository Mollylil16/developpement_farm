...
CREATE TABLE IF NOT EXISTS collaborations (
      ...
      date_invitation VARCHAR(255) NOT NULL,
      date_acceptation VARCHAR(255),
      notes VARCHAR(255),
      date_creation VARCHAR(255) DEFAULT NOW(),
      derniere_modification VARCHAR(255) DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS stocks_aliments (
      ...
      date_derniere_entree VARCHAR(255),
      date_derniere_sortie VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS sevrages (
      ...
      date_sevrage VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS rappels_vaccinations (
      ...
      date_rappel VARCHAR(255) NOT NULL,
      envoi INTEGER DEFAULT 0 CHECK (envoi IN (0, 1)),
      date_envoi VARCHAR(255),
