...
import { CHART_PRIMARY_COLOR, CHART_SECONDARY_COLOR, CHART_HEIGHT_LARGE, CHART_HEIGHT_MEDIUM, axisStyle, axisTickStyle, gridStyle, tooltipStyle, lineStyle, barStyle, PIE_COLORS } from '../utils/chartStyles'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {metricCards.map((card) => (
          <div
            key={card.name}
            className="bg-white rounded-2xl p-6 border border-gray-100 shadow-theme-sm hover:shadow-theme-md transition-shadow"
          >
          ...
          <ResponsiveContainer width="100%" height={CHART_HEIGHT_LARGE}>
            <BarChart data={financeStats.revenue_by_plan}>
              ...
              <Tooltip
                ...
                formatter={(value: any) => formatCurrency(value)}
              />
              <Bar dataKey="total_revenue" fill={CHART_PRIMARY_COLOR} radius={[5, 5, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      )}
